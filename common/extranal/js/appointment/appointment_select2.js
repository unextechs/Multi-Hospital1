...
$(document).ready(function () {
  ...
  $(document.body).on("change", "#pos_select", function () {
    ...
    if (v === "add_new") {
      ...
      $(".pos_client").find('input[name="p_birthdate"]').prop('required', true);
      $(".pos_client").find('select[name="p_gender"]').prop('required', true);
    } else {
      $(".pos_client").hide();
      $(".pos_client").find('input[name="p_name"]').prop('required', false);
      $(".pos_client").find('input[name="p_phone"]').prop('required', false);
      $(".pos_client").find('input[name="p_birthdate"]').prop('required', false);
      $(".pos_client").find('select[name="p_gender"]').prop('required', false);
    }
  });
  $(".pos_client1").hide();
