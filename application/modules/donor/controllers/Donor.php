...
class Donor extends MX_Controller
{
    ...
    public function addDonor()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (empty($id)) {
                ...
                show_swal(lang('donor_added_successfully'), 'success', lang('added'));
            } else {
                $this->donor_model->updateDonor($id, $data);
                show_swal(lang('donor_updated_successfully'), 'success', lang('updated'));
            }
            redirect('donor');
        }
    }
    ...
    function delete()
    {
        ...
        show_swal(lang('donor_deleted_successfully'), 'warning', lang('deleted'));
        redirect('donor');
    }
    ...
    public function updateBloodBank()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            show_swal(lang('blood_bank_updated'), 'success', lang('updated'));
            redirect('donor/bloodBank');
        }
    }
