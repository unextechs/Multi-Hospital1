                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-group">
                                            <label
                                                ...
                                                <span class="text-danger">*</span></label>
                                            <select
                                                class="form-control form-control-lg shadow-sm <?php if (empty($lab->patient)) { ?> pos_select <?php } ?>"
                                                id="<?php if (empty($lab->patient)) { ?> pos_select <?php } ?>"
                                                name="patient" required style="pointer-events: none;">
                                                <?php
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button type="submit" name="submit" id="submit"
                                            onclick="document.querySelector('#submission_type').value = 'submit';"
