    ...
    <section class="wrapper site-min-height">
            ...
            <div class="no-print">
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        ...
                        <form role="form" id="editLabForm" class="clearfix" action="lab/addLab" method="post"
                            enctype="multipart/form-data">

                            <div class="">
                                <div class="col-md-6 lab pad_bot">
                                    <label for="exampleInputEmail1"> <?php echo lang('date'); ?></label>
                                    <input type="text" class="form-control pay_in default-date-picker" name="date"
                                        value='<?php
                                    ...
                                    <select class="form-control form-control-lg m-bot15 pos_select" id="pos_select"
                                        ...
                                        <?php if (!empty($lab_single->patient)) { ?>
                                            <option value="<?php echo $patients->id; ?>" selected="selected">
                                                <?php echo $patients->name; ?> - <?php echo $patients->id; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="pos_client">
                                    ...
                                    <div class="col-md-8 lab pad_bot">
                                        <div class="col-md-3 lab_label">
                                            <label for="exampleInputEmail1"> <?php echo lang('patient'); ?>
                                                <?php echo lang('birth_date'); ?> &ast; </label>
                                        </div>
                                        <div class="col-md-9">
                                            <input
                                                class="form-control form-control-inline input-medium default-date-picker"
                                                type="text" name="birthdate" value="" placeholder=""
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group m-bot15">
                                                ...
                                                <input type="number" min="0" max="150"
                                                    class="form-control form-control-lg" name="years" value=''
                                                    placeholder="<?php echo lang('years'); ?>">
                                                <span class="input-group-addon"><?php echo lang('y'); ?></span>
                                                <input type="number" class="form-control input-group-addon" min="0"
                                                    max="12" name="months" value=''
                                                    placeholder="<?php echo lang('months'); ?>">
                                                <span class="input-group-addon"><?php echo lang('m'); ?></span>
                                                <input type="number" class="form-control input-group-addon" name="days"
                                                    min="0" max="29" value='' placeholder="<?php echo lang('days'); ?>">
                                    ...
                                    <div class="col-md-8 lab pad_bot">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control form-control-lg m-bot15" name="p_gender"
                                                value=''>
                                ...
                                <div class="col-md-6 lab pad_bot">
                                    ...
                                    <select
                                        class="form-control form-control-lg m-bot15 js-example-basic-multiple template"
                                        id="template" name="template" value=''>
        ...
        <section class="col-md-12">
            <header class="panel-heading">
                ...
                <div class="col-md-2 no-print float-right">
