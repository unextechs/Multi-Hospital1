                            ...
                            <ul class="nav nav-tabs mb-4">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab"
                                        href="#all"><?php echo lang('all'); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab"
                                        href="#pending"><?php echo lang('pending_confirmation'); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab"
                                        href="#confirmed"><?php echo lang('confirmed'); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab"
                                        href="#treated"><?php echo lang('treated'); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab"
                                        href="#cancelled"><?php echo lang('cancelled'); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab"
                                        href="#requested"><?php echo lang('requested'); ?></a>
                                </li>
                            </ul>
                                    ...
                                    <table class="table table-bordered" id="editable-sample5" width="100%">
                                        <thead>
                                            <tr class="bg-light">
                                                ...
                                                <th class="font-weight-bold no-print"><?php echo lang('options'); ?>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
                ...
                <form role="form" action="appointment/addNew" id="addAppointmentForm" method="post" class="clearfix"
                    ...
                    <div class="form-row">
                        <div class="col-md-6 patient_div">
                            ...
                            <select class="form-control form-control-lg col-sm-8 m-bot15 pos_select" id="pos_select"
                        ...
                        <div class="pos_client clearfix col-md-12 row">
                            <div class="payment pad_bot float-right patient_div col-md-6 mt-3">
                                ...
                                <input type="text" class="form-control form-control-lg col-sm-8 pay_in" name="p_name"
                                    value='' placeholder="">
                            </div>
                            <div class="payment pad_bot float-right col-md-6 mt-3">
                                <label for="exampleInputEmail1"> <?php echo lang('patient'); ?>
                                    <?php echo lang('email'); ?></label>
                                <input type="text" class="form-control form-control-lg col-sm-8 pay_in" name="p_email"
                                    value='' placeholder="">
                            </div>
                            <div class="payment pad_bot float-right col-md-6 mt-3">
                                <label for="exampleInputEmail1"> <?php echo lang('patient'); ?>
                                    <?php echo lang('phone'); ?> <span class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-lg col-sm-8 pay_in" name="p_phone"
                                    value='' placeholder="">
                            </div>
                            <div class="payment pad_bot float-right col-md-6 mt-3">
                                <label for="exampleInputEmail1"> <?php echo lang('date_of_birth'); ?> <span
                                        class="text-danger">*</span></label>
                                <input type="text"
                                    class="form-control form-control-lg col-sm-8 pay_in default-date-picker"
                                    name="p_birthdate" value='' placeholder="" autocomplete="off"
                                    onkeypress="return false;">
                            </div>
                            <div class="payment pad_bot float-right col-md-6 mt-3">
                                <label for="exampleInputEmail1"> <?php echo lang('national_id'); ?></label>
                                <input type="text" class="form-control form-control-lg col-sm-8 pay_in"
                                    name="p_national_id" value='' placeholder="">
                            </div>
                            ...
                            <div class="payment pad_bot float-right col-md-6 mt-3">
                                ...
                                <select class="form-control form-control-lg col-sm-8" name="p_bloodgroup">
                            ...
                            <div class="payment pad_bot float-right col-md-6 mt-3">
                                ...
                                <input type="text" class="form-control form-control-lg col-sm-8 pay_in"
                                    name="p_emergency_contact_name" value='' placeholder="">
                            </div>
                            <div class="payment pad_bot float-right col-md-6 mt-3">
                                <label for="exampleInputEmail1"> <?php echo lang('emergency_contact_number'); ?></label>
                                <input type="text" class="form-control form-control-lg col-sm-8 pay_in"
                                    name="p_emergency_contact_number" value='' placeholder="">
                            </div>
                        </div>
                        <div class="col-md-6 doctor_div">
                            <label for="exampleInputEmail1"> <?php echo lang('doctor'); ?> &#42;</label>
                            <select class="form-control form-control-lg col-sm-8 m-bot15" id="adoctors" name="doctor"
                                value='' required>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <input type="text" class="form-control form-control-lg col-sm-8 default-date-picker"
                                autocomplete="off" id="date" onkeypress="return false;" name="date"
                                id="exampleInputEmail1" value='' placeholder="" required>
                        </div>
                        <div class="col-md-6 aslots mt-3">
                            <label for="exampleInputEmail1"><?php echo lang('available_slots'); ?> </label>
                            <select class="form-control form-control-lg col-sm-8 m-bot15" name="time_slot" id="aslots"
                                value=''>
                            </select>
                        </div>
                        <div class="col-md-6 mt-3">
                            ...
                            <select class="form-control form-control-lg col-sm-8 m-bot15" name="status" value=''>
                                <option value="Pending Confirmation"> <?php echo lang('pending_confirmation'); ?>
                                </option>
                        ...
                        <div class="col-md-6 mt-3">
                            <label class="col-sm-4"><?php echo lang('visit'); ?> <?php echo lang('type'); ?>
                                &#42;</label>
                            <select class="form-control form-control-lg col-sm-8 m-bot15" name="visit_description"
                        ...
                        <?php if (!$this->ion_auth->in_group(array('Nurse', 'Doctor'))) { ?>
                            ...
                            <div class="payment_label col-md-6 d-none deposit_type">
                                ...
                                <div class="">
                                    <select
                                        class="form-control form-control-lg col-sm-8 m-bot15 js-example-basic-single selecttype"
                                ...
                                <div class="cardPayment">
                                    ...
                                    <?php if ($payment_gateway == 'PayPal') { ?>
                                        <div class="col-md-12 payment pad_bot my-3">
                                            ...
                                            <select class="form-control form-control-lg col-sm-8 m-bot15" name="card_type"
                                                value=''>
                                    ...
                                    <?php if ($payment_gateway == '2Checkout' || $payment_gateway == 'PayPal') { ?>
                                        <div class="col-md-12 payment pad_bot my-3">
                                            ...
                                            <input type="text" id="cardholder"
                                                class="form-control form-control-lg col-sm-8 pay_in" name="cardholder" value=''
                                                placeholder="">
                                        </div>
                                    <?php } ?>
                                    ...
                                    <?php if ($payment_gateway != 'Pay U Money' && $payment_gateway != 'Paystack' && $payment_gateway != 'SSLCOMMERZ' && $payment_gateway != 'Paytm') { ?>
                                        <div class="col-md-12 payment pad_bot my-3">
                                            ...
                                            <input type="text" id="card" class="form-control form-control-lg col-sm-8 pay_in"
                                        ...
                                        <div class="col-md-12 payment pad_bot mt-3 my-3">
                                            ...
                                            <input type="text" class="form-control form-control-lg col-sm-8 pay_in" id="expire"
                                        ...
                                        <div class="col-md-12 payment pad_bot mt-3 my-3">
                                            ...
                                            <input type="text" class="form-control form-control-lg col-sm-8 pay_in" id="cvv"
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group cardsubmit btn-block d-none">
                                        <button type="submit" name="pay_now" id="submit-btn"
                                            class="btn btn-primary btn-block float-right" <?php if ($settings->payment_gateway == 'Stripe') { ?>onClick="stripePay(event);" <?php } ?>                             <?php if ($settings->payment_gateway == '2Checkout' && $twocheckout->status == 'live') { ?>onClick="twoCheckoutPay(event);" <?php } ?>>
                                            <?php echo lang('submit'); ?></button>
                                    </div>
                                </div>
                            </div>
                        <?php } else { ?>
                            <div class="form-group payment btn-block">
                                <button type="submit" name="submit2" id="submit1"
                                    class="btn btn-primary btn-block float-right mr-0">
                                    <?php echo lang('submit'); ?></button>
                            </div>
                        <?php } ?>
                    </div>
            ...
            <div class="modal-body row">
                <form role="form" id="editAppointmentForm" action="appointment/addNew" class="clearfix" method="post"
                    ...
                    <div class="form-row">
                        <div class="col-md-6 patient_div">
                            <label for="exampleInputEmail1"> <?php echo lang('patient'); ?> &#42;</label>
                            <select class="form-control form-control-lg col-sm-8 m-bot15  pos_select1 patient"
                                id="pos_select1" name="patient" value='' required>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 doctor_div1">
                            <label for="exampleInputEmail1"> <?php echo lang('doctor'); ?> &#42;</label>
                            <select class="form-control form-control-lg col-sm-8 m-bot15 doctor" id="adoctors1"
                        ...
                        <div class="col-md-6 mt-3">
                            <label for="exampleInputEmail1"> <?php echo lang('date'); ?> &#42;</label>
                            <input type="text" class="form-control form-control-lg col-sm-8 default-date-picker"
                                autocomplete="off" id="date1" required="" onkeypress="return false;" name="date"
                                id="exampleInputEmail1" value='' placeholder="">
                        </div>
                        <div class="col-md-6 mt-3">
                            <label for="exampleInputEmail1">Available Slots</label>
                            <select class="form-control form-control-lg col-sm-8 m-bot15" name="time_slot" id="aslots1"
                                value=''>
                            </select>
                        </div>
                        <div class="col-md-6 mt-3">
                        ...
                        <?php if (!$this->ion_auth->in_group(array('Nurse', 'Doctor'))) { ?>
                            ...
                            <div class="col-md-12 d-none payment_status form-group mt-3">
                                <label for="" class="col-sm-4"> <?php echo lang('payment'); ?>
                                    <?php echo lang('status'); ?></label><br>
                                ...
                                <div class="card1">
                                    ...
                                    <?php if ($payment_gateway == '2Checkout' || $payment_gateway == 'PayPal') { ?>
                                        <div class="col-md-12 payment pad_bot">
                                            <label for="exampleInputEmail1"> <?php echo lang('cardholder'); ?>
                                                <?php echo lang('name'); ?></label>
                                            <input type="text" id="cardholder1"
                                                class="form-control form-control-lg col-sm-8 pay_in" name="cardholder" value=''
                                                placeholder="">
                                        </div>
                                    <?php } ?>
                                    <?php if ($payment_gateway != 'Pay U Money' && $payment_gateway != 'Paystack' && $payment_gateway != 'SSLCOMMERZ' && $payment_gateway != 'Paytm') { ?>
                                        <div class="col-md-12 payment pad_bot">
                                            <label for="exampleInputEmail1"> <?php echo lang('card'); ?>
                                                <?php echo lang('number'); ?></label>
                                            <input type="text" id="card1" class="form-control form-control-lg col-sm-8 pay_in"
                                                name="card_number" value='' placeholder="">
                                        </div>
                                        ...
                                        <div class="col-md-8 payment pad_bot">
                                            <label for="exampleInputEmail1"> <?php echo lang('expire'); ?>
                                                <?php echo lang('date'); ?></label>
                                            <input type="text" class="form-control form-control-lg col-sm-8 pay_in" id="expire1"
                                                data-date="" data-date-format="MM YY" placeholder="Expiry (MM/YY)"
                                                name="expire_date" maxlength="7" aria-describedby="basic-addon1" value=''
                                        ...
                                        <div class="col-md-4 payment pad_bot">
                                            <label for="exampleInputEmail1"> <?php echo lang('cvv'); ?> </label>
                                            <input type="text" class="form-control form-control-lg col-sm-8 pay_in" id="cvv1"
                                                maxlength="3" name="cvv" value='' placeholder="">
                                        </div>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group cardsubmit1  btn-block d-none">
                                        <button type="submit" name="pay_now" id="submit-btn1"
                                            class="btn btn-primary btn-block float-right" <?php if ($settings->payment_gateway == 'Stripe') { ?>onClick="stripePay1(event);" <?php } ?>                                       <?php if ($settings->payment_gateway == '2Checkout' && $twocheckout->status == 'live') { ?>onClick="twoCheckoutPay1(event);" <?php } ?>>
                                            <?php echo lang('submit'); ?></button>
                                    </div>
                                </div>
                            </div>
...
<div class="modal fade modal-enhanced" role="dialog" id="cmodal">
...
<script>
    $(document).ready(function () {
        ...
        // Also handle Edit Appointment Form
