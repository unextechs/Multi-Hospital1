        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <!-- Main content -->
                    <div class="invoice p-3 mb-3" style="position: relative; background-image: url('<?php echo $settings->logo; ?>'); background-repeat: no-repeat; background-position: center center; background-size: 40%; opacity: 1;">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                                ...
                                <b><?php echo lang('patient_id') ?>:</b> <?php echo $patient_info->hospital_patient_id ?><br>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="amount_th"><?php echo $settings->currency; ?>
                                                        <?php echo $payment->gross_total; ?> </td>
                                                </tr>
                                                <?php
                                            }
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="third_th"><?php echo $settings->currency; ?>
                                                            <?php echo $cat_new[2]; ?> </td>
                                                        <td class="second_th"> <?php echo $cat_new[3]; ?> </td>
                                                        <td class="amount_th"><?php echo $settings->currency; ?>
                                                            <?php echo $cat_new[4]; ?> </td>
                                                    </tr>
                                                <?php
                                                }
                                            }
                                                ...
                                                foreach ($category_name1 as $category_name2) {
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="service_th">
                                                                <?php echo $this->finance_model->getPaymentcategoryById($category_name3[0])->description; ?>
                                                            </td>
                                                            <td class="third_th"><?php echo $settings->currency; ?>
                                                                <?php echo $category_name3[1]; ?> </td>
                                                            <td class="second_th"> <?php echo $category_name3[3]; ?> </td>
                                                            <td class="amount_th"><?php echo $settings->currency; ?>
                                                                <?php echo $category_name3[1] * $category_name3[3]; ?> </td>
                                                        </tr>
                                        <?php
                                                    }
                                                }
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td><?php echo $settings->currency . ' ' . number_format($payment->amount, 2, ".", ""); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><?php echo lang('vat'); ?>
                                                (<?php echo   number_format($payment->vat_amount_percent, 2, ".", ""); ?>%)
                                            </th>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $settings->currency; ?>
                                                <?php echo $r = number_format($this->finance_model->getDepositAmountByPaymentId($payment->id), 2, ".", ""); ?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $settings->currency; ?>
                                                <?php echo number_format($g - $r, 2, ".", ""); ?></td>
                                        </tr>
                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                ...
                                <a rel="noopener" onclick="javascript:window.print();" class="btn btn-secondary float-right mr-2"><i class="fas fa-print"></i>
