                ...
                <div class="document-wrapper">
                    ...
                    <div class="document-content"
                        ...
                        <div style="position: relative; z-index: 1; background-color: rgba(255, 255, 255, 0.95);">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="info-row">
                                                ...
                                                <span class="info-value">
                                                    <?php
                                                    if (!empty($patient_info)) {
                                                        echo 'P ' . $patient_info->hospital_patient_id;
                                                    }
                                                    ?>
                                                </span>
                                            </div>
                                            ...
                                            <div class="info-row">
                                                ...
                                                <span class="info-value">
                                                    ...
                                                    if (!empty($payment->date)) {
                                                        echo date('M d, Y H:i', $payment->date);
                                                    }
                                                    ?>
                                                </span>
                                            </div>
                                                    ...
                                                    if (!empty($payment->category_name)) {
                                                        ...
                                                        foreach ($category_name1 as $category_name2) {
                                                            ...
                                                            if ($category_name3[3] > 0) {
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $i; ?> </td>
                                                                    <td><?php echo $this->finance_model->getPaymentcategoryById($category_name3[0])->category; ?>
                                                                    </td>
                                                                    <td><?php echo $this->finance_model->getPaymentcategoryById($category_name3[0])->description; ?>
                                                                    </td>
                                                                    <td class="text-right"><?php echo $settings->currency; ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <?php if (!empty($payment->vat)) { ?>
                                                <div class="info-row">
                                                    <span class="info-label">VAT
                                                        (<?php echo $payment->vat_amount_percent; ?>%):</span>
                                                    <span class="info-value"><?php echo $settings->currency; ?>
                                                        <?php echo $payment->vat; ?></span>
                                                </div>
                                            <?php } ?>
                                            <div class="info-row">
                                            ...
                                            <div class="info-row">
                                                ...
                                                <span class="info-value"><?php echo $settings->currency; ?>
                                                    <?php echo $this->finance_model->getDepositAmountByPaymentId($payment->id); ?></span>
                                            </div>
                                            <div class="info-row">
                                                <span class="info-label">Amount Due:</span>
                                                <span class="info-value"><?php echo $settings->currency; ?>
                                                    <?php echo $payment->gross_total - $this->finance_model->getDepositAmountByPaymentId($payment->id); ?></span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="payment-status">
                                                ...
                                                <?php } else { ?>
                                                    <div class="status-due">
                                                        <strong><?php echo lang("due_have"); ?></strong>
                                                    </div>
                                                <?php } ?>
                                            </div>
                                        </div>
                            ...
                            <!-- Payment History -->
                            <?php
                            $deposited_amount_payment = $this->finance_model->getDepositByInvoiceId($payment->id);
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <?php foreach ($deposited_amount_payment as $deposited) { ?>
                                                        <tr>
                                                            <td><?php echo date('d-m-y', $deposited->date); ?></td>
                                                            <td><?php echo $settings->currency . ' ' . $deposited->deposited_amount; ?>
                                                            </td>
                                                            <td>
