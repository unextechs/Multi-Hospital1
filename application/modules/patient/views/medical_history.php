                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="info-group mb-4">
                                                                    <h6 class="text-primary mb-3 font-weight-bold">
                                                                        <?php echo lang('personal_information'); ?></h6>

                                                                    <div class="mb-3">
                                                                        <label
                                                                            class="text-muted mb-1"><?php echo lang('email_address'); ?></label>
                                                                        <div class="font-weight-medium">
                                                                            <?php echo $patient->email; ?></div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="font-weight-medium">
                                                                            <?php echo $patient->national_id; ?></div>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-5">
                                                                <div class="info-group mb-4">
                                                                    <h6 class="text-primary mb-3 font-weight-bold">
                                                                        <?php echo lang('medical_information'); ?></h6>

                                                                    <div class="mb-3">
                                                                        <label
                                                                            class="text-muted mb-1"><?php echo lang('blood_group'); ?></label>
                                                                        <div class="font-weight-medium">
                                                                            <?php echo $patient->bloodgroup; ?></div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="font-weight-medium">
                                                                            <?php echo $patient->height; ?></div>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label
                                                                            class="text-muted mb-1"><?php echo lang('weight'); ?></label>
                                                                        <div class="font-weight-medium">
                                                                            <?php echo $patient->weight; ?></div>
                                                                    </div>
                                                                ...
                                                                <div class="info-group">
                                                                    <h6 class="text-primary mb-3 font-weight-bold">
                                                                        <?php echo lang('emergency_contact'); ?></h6>
            ...
            <div class="modal-body p-4">
                <form role="form" id="editPatientForm" action="patient/addNew" method="post"
                    ...
                    <input type="hidden" name="p_id"
                        value='<?php if (!empty($patient->patient_id))
