...
class Patient extends MX_Controller
{
    ...
    public function getCaseList()
    {
        ...
        foreach ($data['cases'] as $case) {
            ...
            $options5 = '<a class="btn btn-info btn-xs btn_width" title="' . lang('add_lab_request') . '" href="lab/addLabView?patient=' . $case->patient_id . '&doctor=' . $case->doctor_id . '"><i class="fas fa-flask"> </i> ' . lang('add_lab_request') . '</a>';
