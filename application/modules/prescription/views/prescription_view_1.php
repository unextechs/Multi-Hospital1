            ...
            <div class="row mb-2 pl-1">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold"><i
                        ...
                        (<?php echo lang('id'); ?>: <?php echo $prescription->id; ?>)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="home"><?php echo lang('prescription') ?></a></li>
                        <li class="breadcrumb-item active"><?php echo lang('view') ?></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="document-wrapper">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h3 class="document-title mb-1">MEDICAL PRESCRIPTION
                                        #<?php echo $prescription->id; ?></h3>
                                    <p class="document-subtitle mb-0"><?php echo date('M d, Y', $prescription->date); ?>
                                        |
                                        <?php echo !empty($doctor) ? (!empty($doctor->title) ? $doctor->title . ' ' : '') . $doctor->name : $settings->title; ?>
                                    </p>
                                </div>
                        ...
                        <div class="document-content">
                            ...
                            <div class="document-section mb-3 text-center">
                                ...
                                <?php endif; ?>
                                <h2 class="font-weight-bold mb-1" style="color: #000;"><?php echo $settings->title; ?>
                                </h2>
                                <h5 class="mb-1"><?php echo $settings->address; ?></h5>
                                <h5 class="mb-0">Tel: <?php echo $settings->phone; ?></h5>
                            </div>

                            <!-- Doctor Information Section -->
                            <div class="document-section mb-2">
                                <h5 class="section-title">PRESCRIBING PHYSICIAN</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="info-row">
                                                ...
                                                <span
                                                    class="info-value"><?php echo !empty($patient) ? $patient->id : 'Not specified'; ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info-row">
                            ...
                            <div class="document-section mb-2">
                                ...
                                <div class="section-content">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="info-row">
                                                <span class="info-label">Symptoms/History:</span>
                                                <span
                                                    class="info-value"><?php echo !empty($prescription->symptom) ? $prescription->symptom : 'Not specified'; ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info-row">
                                            ...
                                            <table class="table table-sm table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="days-col"><?php echo lang('days'); ?></th>
                                            ...
                                            <div class="signature-line">
                                                ...
                                                <div class="signature-space">
                                                    <?php if (!empty($doctor->signature) && file_exists($doctor->signature)): ?>
                                                        <img src="<?php echo $doctor->signature; ?>"
                    ...
                    <div class="document-sidebar">
                        <div class="sidebar-section">
                            ...
                            <div class="summary-item">
                                ...
                                <span class="summary-value">#<?php echo $prescription->id; ?></span>
                            </div>
                            <div class="summary-item">
...
<script>
    ...
    document.getElementById('download').addEventListener('click', function () {
        ...
        var element = document.querySelector('.document-content');
